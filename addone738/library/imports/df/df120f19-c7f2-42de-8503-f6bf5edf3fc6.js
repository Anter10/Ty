...
var ShareConfig = {
    ...
    RECOVER_GAME_SHARE: ['recovergameshare', true], // 看视频复活
    RECOVER_SHARE_GAME_SHARE: ['recoversharegameshare', true], // 分享到群复活
    ...
    GIFT_GIFT_BOX_SHARE: ['free_gift_box_share', true], // 如意宝箱看视频
