window.__require = function e(t, n, r) {
  ...
  Constants: [ function(require, module, exports) {
    ...
    var ShareConfig = {
      ...
      RECOVER_GAME_SHARE_VIDEO: [ "recoversharegameshare", true ],
      RECOVER_SHARE_GAME_SHARE: [ "recovergameshare", true ],
      MAIN_BTN_SHARE: [ "mainbtnshare", false ],
      POJILU_SHARE: [ "pojilushare", false ],
      RANK_SHARE: [ "phbshare", true ],
      FREE_GIFT_SHARE: [ "freegiftshare", true ],
      FREE_GIFT_SHARE_VIDEO: [ "freegiftsharevideo", true ],
      GROUP_RANK_SHARE: [ "group_rank_share", true ],
      GIFT_GIFT_BOX_SHARE_VIDEO: [ "free_gift_box_share", true ],
      GIFT_GIFT_SHARE_BOX_SHARE: [ "free_gift_share_box_share", true ],
      OPEN_RED_PACKET_SHARE: [ "open_red_packet_share", true ],
      OPEN_RED_PACKET_SHARE_VIDEO: [ "open_red_packet_share_video", true ],
      EVERY_DAY_GIFT_DOUBLE_SHARE: [ "every_day_gift_double_share", true ],
      INVITE_FIREND_SHARE: [ "invite_friend_share", false ],
      FREE_DOUBLE_SCORE_SHARE: [ "freeaddscorebigdouble", true ],
      FREE_DOUBLE_SCORE_SHARE_VIDEO: [ "freedoublescorevideo", true ]
    };
  ...
  GeZi: [ function(require, module, exports) {
    ...
    module.exports = function(id, parent) {
      ...
      this.setnum = function(num) {
        if (num) {
          if (num % 2 == 0 && num > 7 && !this.hasout) {
            if (this.block) if (-1 == this.block.id_keep && -1 == this.block.id_dest) if (false == tywx.gamecenter.hasShowxhgNum(num)) {
          ...
          this.num > tywx.ado.Constants.GameCenterConfig.color_list.length && (colorindex %= tywx.ado.Constants.GameCenterConfig.color_list.length);
      ...
      this.settoblockAndNumber = function(num) {
        this.block.posx != this.posx && this.block.posy != this.block.posy && this.block.setinfo(this.color, num);
        this.block.setpos(this.posx, this.posy);
      };
      this.settoblockvalue = function() {
        ...
        pngnum > tywx.ado.Constants.GameCenterConfig.celltilenumColors.length && (pngnum %= tywx.ado.Constants.GameCenterConfig.celltilenumColors.length);
  ...
  LuckBox: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      init: function init() {
        ...
        if ("video" == tywx.config.share_control.ruyibox || tywx.ado.isMinGanIP) {
          this.hideLabel.string = "\u89c6\u9891\u9886\u53d6";
          this.showLabel.string = "\u89c6\u9891\u9886\u53d6";
          this.node.getChildByName("luckboxroot").getChildByName("checkbox").getComponent("cc.Toggle").uncheck();
          this.mflqBtn.getComponent("ShareButton").setShareConfig(tywx.ado.Constants.ShareConfig.GIFT_GIFT_BOX_SHARE_VIDEO);
          this.mflqBtn.getComponent("ShareButton").setButtonCallType(2);
        } else if ("share" == tywx.config.share_control.ruyibox) {
          this.hideLabel.string = "\u514d\u8d39\u9886\u53d6";
          this.showLabel.string = "\u514d\u8d39\u9886\u53d6";
        ...
        tywx.ado.isMinGanIP ? this.needHelpNode.active = false : this.needHelpNode.active = true;
      },
  ...
  MoreTanNumber: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      doubleAddInit: function doubleAddInit() {
        if ("video" == tywx.config.share_control.bigdouble || tywx.ado.isMinGanIP) {
        ...
        } else if ("share" == tywx.config.share_control.bigdouble) {
  ...
  OpenRedPackView: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      initOpenLogic: function initOpenLogic() {
        ...
        if ("video" == tywx.config.share_control.redpack || tywx.ado.isMinGanIP) {
        ...
        } else if ("share" == tywx.config.share_control.redpack) {
        ...
        false == this.data.needShare ? this.openRedPackBtn.setReactCall(true) : this.openRedPackBtn.setShareGroupCall(function() {
          self.playRotate();
        });
      },
      playRotate: function playRotate() {
  ...
  ShareButton: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      callBack: function callBack() {
        tywx.ado.isMinGanIP || 2 == this.calltype ? this.showWXVideo() : 1 == this.calltype && this.shareMiniApp();
      },
  ...
  ShareInterface: [ function(require, module, exports) {
    ...
    tywx.ShareInterface = {
      ...
      shareBack: function shareBack() {
        ...
        var _ref = tywx.ado.Configs.ShareLimit || [ 500, 2e3 ], _ref2 = _slicedToArray(_ref, 2), min_time = _ref2[0], max_time = _ref2[1];
        ...
        } else shareParams.failCallback && shareParams.failCallback();
              ...
              wx.request({
                ...
                success: function success(res) {
                  ...
                  if (res.data) if (0 !== res.data.code) {
                    ...
                    params.success && params.success();
                  } else tywx.ado.Utils.uploadErrorMsg("invite;requestInviteGetInfo==success--error-1;" + JSON.stringify(res));
                },
                fail: function fail(res) {
  ...
  ado_view_every_day_login: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        if ("video" === tywx.config.share_control.dailydouble || tywx.ado.isMinGanIP) {
          ...
          tywx.ado.isMinGanIP && (this.root.getChildByName("toggle_share").active = false);
        }
      },
      start: function start() {
        tywx.ado.Utils.showWXBanner();
  ...
  celltile: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      visByNum: function visByNum(num, renum) {
        ...
        null == this.shadow ? console.log("shadow is NULL!!!!") : this.shadow.string = renum;
        this.renumber = renum;
      },
      ...
      setColor: function setColor(color) {
        null == this.shadow ? console.log("SETCOLOR", this.shadow) : this.shadow.node.color = color;
      },
  ...
  gamemain: [ function(require, module, exports) {
    ...
    var gamemain = cc.Class({
      ...
      initShowBoxButton: function initShowBoxButton() {
        if ("video" == tywx.config.share_control.comboitem || tywx.ado.isMinGanIP) {
        ...
        } else if ("share" == tywx.config.share_control.comboitem) {
          this.mflqshareNode.active = true;
      ...
      showCrossAd: function showCrossAd() {
        ...
        if (true === tywx.config.auditing || !adInfos || adInfos.length <= 0) return;
      ...
      fhBtnShow: function fhBtnShow() {
        ...
        } else this.recoverNumber == tywx.ado.Constants.GameCenterConfig.maxrnum ? this.fuHuo.active = false : this.fuHuo.active = true;
      },
      ...
      showRYBoxButton: function showRYBoxButton() {
        this.score >= tywx.config.ruyiScore && false == this.ryBoxBtn.active ? true == tywx.config.auditing ? this.ryBoxBtn.active = false : this.ryBoxBtn.active = true : this.score < tywx.config.ruyiScore && (this.ryBoxBtn.active = false);
        true == tywx.config.auditing && (this.ryBoxBtn.active = false);
      },
      ...
      dealPlayerClickScreen: function dealPlayerClickScreen() {
        ...
        for (var ci = 0; ci < tywx.ado.Constants.GameCenterConfig.geziNumber; ci++) null != this.allpngs[ci] && this.allpngs[ci].getComponent("celltile").stopDaijiEff();
        this.hadClickScreen = true;
        tywx.Timer.setTimer(self, function() {
      ...
      showOneHpEf: function showOneHpEf(item) {
        if ((this.point != this.maxpoint || 1 != this.point) && 0 == item.xx1Icon.node.getNumberOfRunningActions()) {
          ...
          var tmove = cc.moveTo(.6, cc.p(newVec2.x - new1Vec2.x - node.x - 30, newVec2.y - Math.abs(new1Vec2.y) - node.y));
      ...
      update: function update(dt) {
        if (this.startDropTime <= 0) for (var i = 0; i < this.getAllgz().length; i++) {
        ...
        switch (this.gamestate) {
         case tywx.ado.Constants.GameCenterConfig.gameState.checkclick:
          ...
          if (this.g_mask_samecnt >= tywx.ado.Constants.GameCenterConfig.minCanRemoveNumber) {
            ...
            this.scoreLabel.string = this.score;
            for (var i = 0; i < tywx.ado.Constants.GameCenterConfig.geziNumber; i++) if (9999999 != this.getAllmask()[i].step && 0 != this.getAllmask()[i].step) {
      ...
      dealLianJiLogic: function dealLianJiLogic() {
        ...
        for (var j = 0; j < tywx.ado.Constants.GameCenterConfig.geziNumber; j++) {
          ...
          if (this.g_mask_samecnt >= tywx.ado.Constants.GameCenterConfig.minCanRemoveNumber) {
            ...
            this.scoreLabel.string = this.score;
            for (var i = 0; i < 25; i++) if (9999999 != this.getAllmask()[i].step && 0 != this.getAllmask()[i].step) {
              this.getAllgz()[i].block.speed_keep = tywx.ado.Constants.GameCenterConfig.gezi_pitch * this.getAllmask()[i].step / this.getMergeTime();
              this.getAllgz()[i].block.actiontime_keep = this.getMergeTime() / this.getAllmask()[i].step;
              this.getAllgz()[i].block.id_keep = i;
              this.getAllgz()[i].block.id_dest = this.getAllmask()[i].from;
      ...
      setFHBtnCallBack: function setFHBtnCallBack(calltype) {
        if ("video" == tywx.config.share_control.fuhuo) {
        ...
        } else if ("share" == tywx.config.share_control.fuhuo) {
      ...
      finalDealMask: function finalDealMask() {
        for (var i = 0; i < tywx.ado.Constants.GameCenterConfig.geziNumber; i++) this.getAllgz()[i].settoblock();
      },
      ...
      startDropAnimation: function startDropAnimation() {
        var self = this;
        var allpos = [];
        for (var i = 0; i < tywx.ado.Constants.GameCenterConfig.geziNumber; i++) this.allpngs[i].active = false;
        tywx.Timer.setTimer(self, function() {
          for (var i = 0; i < tywx.ado.Constants.GameCenterConfig.geziNumber; i++) {
      ...
      resetAllMask: function resetAllMask() {
        if (false == this.refreshingMask) {
          ...
          for (var i = 0; i < tywx.ado.Constants.GameCenterConfig.geziNumber; i++) this.getAllmask()[i].reset();
      ...
      refreshbymask: function refreshbymask() {
        for (var i = 0; i < tywx.ado.Constants.GameCenterConfig.geziNumber; i++) if (9999999 != this.getAllmask()[i].step && 0 != this.getAllmask()[i].step) {
          ...
          while (tmpid < tywx.ado.Constants.GameCenterConfig.geziNumber) {
            if (9999999 == this.getAllmask()[tmpid].step || 0 == this.getAllmask()[tmpid].step) {
              topid = tmpid;
              break;
            }
            tmpid += 5;
      ...
      getPjNumberName: function getPjNumberName(id) {
        ...
        var total = 0;
        var gzindex = 1;
        for (var tcellIndex = 0; tcellIndex < allids.length; tcellIndex++) if (this.getAllmask()[tcellIndex]) {
      ...
      printMaskMsg: function printMaskMsg() {
        for (var gzIndex = 0; gzIndex < 25; gzIndex++) this.getAllmask()[gzIndex].showMSG();
      },
      ...
      playMergeAnimation: function playMergeAnimation() {
        if (this.g_clickid) {
          ...
          } else this.cmergeAniNode.position = this.allpngs[this.g_clickid].position;
      ...
      dealAddNumber: function dealAddNumber(id) {
        0 != this.allpngs[id].getComponent("celltile").prenum && this.addXHGId(this.allpngs[id].getComponent("celltile").prenum);
      },
      ...
      storePhoto: function storePhoto() {
        ...
        var dcs = cc.size(contentsize.width, contentsize.height);
        var rate_width = dcs.width / ds.width, rate_height = dcs.height / ds.height;
        var d_x = (ds.width - dcs.width) / 2, d_y = (ds.height - dcs.height) / 2 - 71;
        var rate_x = d_x / ds.width, rate_y = d_y / ds.height;
        var w = cw * rate_width;
        var h = is_ipx ? w * (dcs.height / dcs.width) : ch * rate_height;
        var x = cw * rate_x;
  ...
  gamestart: [ function(require, module, exports) {
    ...
    var gamestart = cc.Class({
      ...
      refreshAfterGetConfig: function refreshAfterGetConfig() {
        ...
        tywx.config.auditing ? this.nodeMoreGame.active = false : this.nodeMoreGame.active = true;
        this.loginSuccess();
      },
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        for (var hindex = 0; hindex < this.allhelpdata.length; hindex++) {
          ...
          if (hindex < 3) {
            item.y = 80;
            item.x = 150 * hindex + 90;
          } else {
            item.y = 220;
            item.x = 150 * (hindex - 3) + 90;
          }
          this.curgzPos.push({
            x: item.x,
            y: item.y
      ...
      newPlayerGuideCall: function newPlayerGuideCall() {
        ...
        if (0 == this.curHelpNumber) {
          ...
          var call1 = cc.callFunc(function() {
            var mv1 = cc.moveTo(.2, cc.p(self.allhelpCells[4].x, self.allhelpCells[4].y));
            var mv2 = cc.moveTo(.2, cc.p(self.allhelpCells[4].x, self.allhelpCells[4].y));
          ...
          var call2 = cc.callFunc(function() {
            ...
            var mv1 = cc.moveBy(.2, cc.p(0, -65));
            var mv2 = cc.moveBy(.2, cc.p(0, -65));
            self.allhelpCells[3].getComponent("celltile").node.runAction(mv1);
            self.allhelpCells[5].getComponent("celltile").node.runAction(mv2);
          ...
          var call2 = cc.callFunc(function() {
            ...
            var mv2 = cc.moveTo(.15, cc.p(self.curgzPos[1].x, self.curgzPos[1].y));
            ...
            var mv3 = cc.moveTo(.15, cc.p(self.curgzPos[4].x, self.curgzPos[4].y));
            self.allhelpCells[1].getComponent("celltile").node.runAction(mv3);
            self.allhelpCells[5].getComponent("celltile").node.x = self.curgzPos[5].x;
            self.allhelpCells[5].getComponent("celltile").node.y = self.curgzPos[5].y + 65;
            var mv3 = cc.moveTo(.15, cc.p(self.curgzPos[5].x, self.curgzPos[5].y));
          ...
          var seq = cc.sequence(delay1, call1, delay2, call2);
          this.node.runAction(seq);
        } else 2 == this.curHelpNumber && true == this.curGuidefinish && cc.director.loadScene("gamemain");
      },
      close: function close() {
