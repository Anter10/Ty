...
cc.Class({
        ...
        wx.onMessage(data => {
             ...
             if(data.method == PTypes.friends){
               ...
               self.getGroupFriendData(data.shareTicket);
                ...
                friendspos.x = data.posx;
                friendspos.y = data.posy;
                            ...
                            if(store != true){
                               ...
                               if (data.length <= 8) {
                                ...
                                for (let i = data.length - 1; i >= 0 ; i--) {
                                    ...
                                    if( chazhi > 0 && userData.avatarUrl != tdata.avatarUrl){
                                           frdata = tdata;
                                           frdata.score = fscore;
                                ...
                                // 如果有玩家的分数大于自己的 则显示
                                if(friendspos.x){
                                    // self.friendmsd.x = friendspos.x;
                                }
                                if(friendspos.y){
                                    // self.friendmsd.y = friendspos.y - 60;
                                }
 ...
 /*
        ...
        思路: 游戏逻辑需要
    */
   createIcon: function(sprite, avatarUrl, index) {
        var self = this;
        var tsp = sprite;
        try {
