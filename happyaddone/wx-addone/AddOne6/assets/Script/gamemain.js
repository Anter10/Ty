...
var gamemain = cc.Class({
    ...
    onLoad: function () {
        ...
        this.produceHPAni(this.showNumberNode.getChildByName("rootnode").getChildByName("xin2048_baoxiang_03").getChildByName("sharebuttton"), 0.6, 1.1);
