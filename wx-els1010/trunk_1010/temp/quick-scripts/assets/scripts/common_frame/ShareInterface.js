(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common_frame/ShareInterface.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e4b6chWbQ9JTYaXQLP5aFym', 'ShareInterface', __filename);
...
tywx.ShareInterface = {
    ...
    shareBack: function shareBack() {
        ...
        var _ref = tywx.tt.configManager.getInstance().ShareLimit || [3000, 10000],
    ...
    commonFialedCallback: function commonFialedCallback() {
        if (tywx.tt.configManager.getInstance().auditing || tywx.tt.isMinGanIP || !tywx.tt.configManager.getInstance().ShareToast.show) {
            return;
        }
