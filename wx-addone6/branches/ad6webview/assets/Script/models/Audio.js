...
cc.Class({
    ...
    */
    ...
    changeTexture:function(){
          if (ty.ado.AudioManager.getIsMute()) {
              curAudioState = 0;
          } else {
              curAudioState = 1;
          }
    ...
    controlAudio: function () {
        ...
        if (curAudioState == 1) {
            this.pause();
            //ty.stopMusic();
            ty.ado.AudioManager.stopMusic();
            curAudioState = 0;
            ty.ado.AudioManager.setIsMute(true);
        } else if (curAudioState == 0) {
            this.play();
            //ty.playMusic();
            ty.ado.AudioManager.setIsMute(false);
