 ...
 */
window.ty = {};
ty.isInWXChat = ("wechatgame"===cc.sys.browserType);
//基础状态信息
ty.StateInfo = {
...
ty.SystemInfo = {
   ...
   loginUrl       : 'https://openwaxiaofz.nalrer.cn/',//'http://openelsfkfz.nalrer.cn/',                       // 仿真
   shareManagerUrl: 'https://market.touch4.me/',
   deviceId       : 'wechatGame',
   wxAppId        : 'wx1505f9b75e01fe46',                                  
   appId          : 9999,
   gameId         : 20187,
   hall_version   : "hall37",
...
(function() {
     ...
     */
    ty.hex_md5 = function (s){ return binl2hex(core_md5(str2binl(s), s.length * chrsz));};
    ty.b64_md5 = function (s){ return binl2b64(core_md5(str2binl(s), s.length * chrsz));};
    ty.str_md5 = function (s){ return binl2str(core_md5(str2binl(s), s.length * chrsz));};
    ty.hex_hmac_md5 =function (key, data) { return binl2hex(core_hmac_md5(key, data)); };
    ty.b64_hmac_md5 =function (key, data) { return binl2b64(core_hmac_md5(key, data)); };
    ty.str_hmac_md5 =function (key, data) { return binl2str(core_hmac_md5(key, data)); };
