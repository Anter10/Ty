 ...
 module.exports = (function (parent) {
    ...
    */
    this.adjustmove = function () {
        ...
        if (alp == 2) {
            ...
            this.speedy = 0;
        } else if (alp == ty.ado.Constants.GameCenterConfig.rowcellNumber - 1) {
    ...
    */
    this.adjustdrop = function (spx, spy) {
            ...
            this.actiontime = ty.ado.Constants.GameCenterConfig.drop_time;
            this.speedx = spx;
            this.speedy = spy;
            this.destx = this.parent.getAllgz()[this.id_dest].posx;
            this.desty = this.parent.getAllgz()[this.id_dest].posy;
    ...
    */
    this.tickeffect = function (dt, spr0, spr1) {
        ...
        //    if(this.effectid==1){
        //         spr1.node.x = this.posx + ty.ado.Constants.GameCenterConfig.gezi_size / 2;
        //         spr1.node.y = this.posy + ty.ado.Constants.GameCenterConfig.gezi_size / 2;
