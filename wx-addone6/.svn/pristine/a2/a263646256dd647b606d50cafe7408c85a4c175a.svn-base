...
cc.Class({
    ...
    */
    ...
    setCurNum:function(scn){
         this.scn = scn;
         if (this.scn % 2 == 0 && this.scn > ty.ado.Constants.GameCenterConfig.moreThanTenNumber - 1 && !this.hadout) {
             this.hadout = true;
    ...
    */
    ...
    changeShow: function (num) {
        let colors = ty.ado.Constants.GameCenterConfig.celltilenumColors[num - 1];
    ...
    */
    onLoad() {
        ...
        this.node.on('touchend', function (event) {
            if(self.prenum != 0){
               ty.gamecenter.addXHGId(self.prenum);
            }
            self.touchEft.node.active = false;
