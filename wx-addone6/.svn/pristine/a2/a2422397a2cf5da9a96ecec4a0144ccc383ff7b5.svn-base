...
// };
// ! Modify by luning [11-10-2018] 分享策略修改，所有的分享不再检测是否是群分享
let ShareConfig = {
    FIRST_PAGE_SHARE             : ['firstpageshare', false],                // 首页分享
...
// * 交叉导流默认配置
let CrossAdDefaultConfig = {
    "icon_interval": 10,
    "icon_id": "214",
    "icon_url": [
        "https://elsfkws.nalrer.cn/teris/share_image/jiayi/daoliu01.png"
    ],
    "icon_weight": 10,
    "icon_type": 1,
    "icon_skip_type": 1,
