(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/models/ShareButton.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
...
cc.Class({
    ...
    */
    ...
    callBack: function callBack() {
        if ((tywx.ado.isMinGanIP || this.calltype == 2) && tywx.ado.isCanWatchVideo) {
            this.showWXVideo();
        } else if (this.calltype == 1 || !tywx.ado.isCanWatchVideo) {
            this.shareMiniApp();
        }
    },
