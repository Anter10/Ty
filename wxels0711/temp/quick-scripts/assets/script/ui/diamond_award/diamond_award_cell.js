(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/diamond_award/diamond_award_cell.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd6476wHjntE5rcedcaPth8n', 'diamond_award_cell', __filename);
// script/ui/diamond_award/diamond_award_cell.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        for (var i = 0; i < this.btn_Nodes.length; i++) {
    ...
    _MsgRewardInfo: function _MsgRewardInfo(params) {
        if (params.result.action === tywx.EventType.CMD_ACTION_ADD_DIAMOND) {
            if (params.result.status === 1 && params.result.reason === 2) {
                // 邀请奖励领取成功
                this.rewardState = 2;
                this.updateState();
...
cc._RF.pop();
        ...
        //# sourceMappingURL=diamond_award_cell.js.map
