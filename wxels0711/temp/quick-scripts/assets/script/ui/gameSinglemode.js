(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/gameSinglemode.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ed2d0SklBpM3LG7EsJ4Hud3', 'gameSinglemode', __filename);
// script/ui/gameSinglemode.js
...
cc.Class({
    ...
    updateWinLine: function updateWinLine() {
        var tmp_model = tywx.UIManager.game.model;
        if (tmp_model.mconf.isWhisper || tmp_model.mconf.isEndless) {
            ...
            var labelContent = this.winline.getChildByName('label_win').getComponent(cc.Label);
     ...
     */
    refreshZhuBaoInfo: function refreshZhuBaoInfo(params) {
        var tmp_model = tywx.UIManager.game.model;
        if (!tmp_model.mconf.isEndless) return;
        var tmp_grid = tmp_model.mgrid[0];
        var zhubao_count = tmp_grid.mcore.zhubao_count;
        var zhubao_max = tmp_grid.mcore.zhubao_max;
    ...
    showWisperStart: function showWisperStart(index) {
        console.log('showWisperStart', index);
        var self = this;
        this.game = tywx.UIManager.game;
        var animation_end_callback = function animation_end_callback() {
            self.game.hiden_mask();
            self.hideMask();
        };
        var content = this.game.win_content.split("\n")[1][index];

        var ani = cc.instantiate(this.prefabWisperStartAni);
    ...
    hideMask: function hideMask() {
        //! 右侧区域
        var self = this;
        this.game_mask.runAction(cc.sequence(cc.fadeOut(0.5), cc.callFunc(function () {
    ...
    showLose: function showLose() {
        ...
        var is_endless = tywx.UIManager.game.model.mconf.isEndless;
    ...
    mask_btn_click: function mask_btn_click() {
    ...
    onloseBackHandler: function onloseBackHandler(eve) {
        this.lose_single.active = false;
        this.stopAllParticleSys();
        this.game.loseBackToHome();
    },
    onloseRegameHandler: function onloseRegameHandler(eve) {
        var is_endless = tywx.UIManager.game.model.mconf.isEndless;
        if (is_endless) {
    ...
    onwinNextHandler: function onwinNextHandler(eve) {
        this.stopAllParticleSys();
        this.win_single.active = false;
        this.whisper_win_single.active = false;
    ...
    // update (dt) {},
    onBtnReviveClickCallback: function onBtnReviveClickCallback() {
        var self = this;
        tywx.ShareInterface.shareMsg({
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gameSinglemode.js.map
