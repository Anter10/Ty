(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/CommonFrame/PropagateInterface.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '91f6evtU8JJFbIPgvh1h6pp', 'PropagateInterface', __filename);
...
tywx.SecretLanguage = {
    ...
    get_wxtetris_makeimage: function get_wxtetris_makeimage(plaintext, ciphertext, type) {
        var reqObj = {};
        ...
        var finalUrl = tywx.SystemInfo.loginUrl + 'api/wxtetris/makeimage' + '?' + paramStrList.join('&');
        console.log(finalUrl);
        var successcb = function successcb(ret) {
            ret['type'] = type;
            tywx.NotificationCenter.trigger(tywx.EventType.GET_SECRET_LANGUAGE_IMAGE_SUCCESS, ret);
        };

        var failcb = function failcb(ret) {
            tywx.NotificationCenter.trigger(tywx.EventType.GET_SECRET_LANGUAGE_IMAGE_FAIL, ret);
        };
        tywx.HttpUtil.httpGet({ 'url': finalUrl }, successcb, failcb);
    }
