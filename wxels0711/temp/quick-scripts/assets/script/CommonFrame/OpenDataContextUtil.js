(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/CommonFrame/OpenDataContextUtil.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '88818AxTJhH+qEB/cWx0uM8', 'OpenDataContextUtil', __filename);
// script/CommonFrame/OpenDataContextUtil.js
...
tywx.OpenDataContextUtil = {
        ...
        for (var key in this.methodCallDic) {
            try {
                ...
                if (context[key]) {
                    ...
                    if (new Date().valueOf() - this.methodCallDic[key]["time"] > 500) {
                        //两秒都没返回
     ...
     * @returns {string}
     */
    getFriendCloudStorage: function getFriendCloudStorage(types, successCallBack, failCallBack) {
